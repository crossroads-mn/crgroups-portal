...
function upload_to_database($data) {
...
//if ($_SESSION["access"] == "granted") {
	...
	if ($exists_in_db) {
		//Run the UPDATE
		$result = mysqli_query($DB_CONN, $update) or die('{"records": [{"error": "' . mysqli_error($DB_CONN) . '"}]}');
		error_log($update);
		...
		//Run the INSERT
		$result = mysqli_query($DB_CONN, $insert) or die('{"records": [{"error": "' . mysqli_error($DB_CONN) . '"}]}');
		error_log($insert);
