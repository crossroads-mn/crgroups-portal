...
if (array_key_exists('CONTENT', $obj['data'])) {
	$obj['data']['CONTENT'] = iconv('UTF-8', 'ASCII//TRANSLIT', $DB_CONN->real_escape_string($obj['data']['CONTENT']));
}

if (array_key_exists('LOCATION', $obj['data'])) {
	$obj['data']['LOCATION'] = iconv('UTF-8', 'ASCII//TRANSLIT', $DB_CONN->real_escape_string($obj['data']['LOCATION']));
}

if (array_key_exists('REGISTRATION_LINK', $obj['data'])) {
	$obj['data']['REGISTRATION_LINK'] = iconv('UTF-8', 'ASCII//TRANSLIT', $DB_CONN->real_escape_string($obj['data']['REGISTRATION_LINK']));
}

if (array_key_exists('NOTES', $obj['data'])) {
	$obj['data']['NOTES'] = iconv('UTF-8', 'ASCII//TRANSLIT', $DB_CONN->real_escape_string($obj['data']['NOTES']));
}

if (array_key_exists('LEADER', $obj['data'])) {
	$obj['data']['LEADER'] = iconv('UTF-8', 'ASCII//TRANSLIT', $DB_CONN->real_escape_string($obj['data']['LEADER']));
}

if (array_key_exists('PHONE_NUMBER', $obj['data'])) {
	$obj['data']['PHONE_NUMBER'] = iconv('UTF-8', 'ASCII//TRANSLIT', $DB_CONN->real_escape_string($obj['data']['PHONE_NUMBER']));
}

if (array_key_exists('DESCRIPTION', $obj['data'])) {
	$obj['data']['DESCRIPTION'] = iconv('UTF-8', 'ASCII//TRANSLIT', $DB_CONN->real_escape_string($obj['data']['DESCRIPTION']));
}

if (array_key_exists('TARGET_AUDIENCE', $obj['data'])) {
	$obj['data']['TARGET_AUDIENCE'] = iconv('UTF-8', 'ASCII//TRANSLIT', $DB_CONN->real_escape_string($obj['data']['TARGET_AUDIENCE']));
}
...
if (array_key_exists('TITLE', $obj['data'])) {
	$obj['data']['TITLE'] = iconv('UTF-8', 'ASCII//TRANSLIT', $DB_CONN->real_escape_string($obj['data']['TITLE']));
}

if (array_key_exists('COST', $obj['data'])) {
	$obj['data']['COST'] = iconv('UTF-8', 'ASCII//TRANSLIT', $DB_CONN->real_escape_string($obj['data']['COST']));
}

if (array_key_exists('WHY', $obj['data'])) {
	$obj['data']['WHY'] = iconv('UTF-8', 'ASCII//TRANSLIT', $DB_CONN->real_escape_string($obj['data']['WHY']));
}

if (array_key_exists('BOOK_LINKS', $obj['data'])) {
	$obj['data']['BOOK_LINKS'] = iconv('UTF-8', 'ASCII//TRANSLIT', $DB_CONN->real_escape_string($obj['data']['BOOK_LINKS']));
}

if (array_key_exists('SEMESTER', $obj['data'])) {
	$obj['data']['SEMESTER'] = iconv('UTF-8', 'ASCII//TRANSLIT', $DB_CONN->real_escape_string($obj['data']['SEMESTER']));
}
...
if (array_key_exists('END_TIME', $obj['data'])) {
	$obj['data']['END_TIME'] = iconv('UTF-8', 'ASCII//TRANSLIT', $DB_CONN->real_escape_string($obj['data']['END_TIME']));
}

if (array_key_exists('CO_LEADER_PHONE', $obj['data'])) {
	$obj['data']['CO_LEADER_PHONE'] = iconv('UTF-8', 'ASCII//TRANSLIT', $DB_CONN->real_escape_string($obj['data']['CO_LEADER_PHONE']));
}

if (array_key_exists('CONTACT_EMAIL', $obj['data'])) {
	$obj['data']['CONTACT_EMAIL'] = iconv('UTF-8', 'ASCII//TRANSLIT', $DB_CONN->real_escape_string($obj['data']['CONTACT_EMAIL']));
}

if (array_key_exists('CO_LEADER_EMAIL', $obj['data'])) {
	$obj['data']['CO_LEADER_EMAIL'] = iconv('UTF-8', 'ASCII//TRANSLIT', $DB_CONN->real_escape_string($obj['data']['CO_LEADER_EMAIL']));
}

if (array_key_exists('DATE_OF_EVENT', $obj['data'])) {
	$obj['data']['DATE_OF_EVENT'] = iconv('UTF-8', 'ASCII//TRANSLIT', $DB_CONN->real_escape_string($obj['data']['DATE_OF_EVENT']));
}

if (array_key_exists('DURATION', $obj['data'])) {
	$obj['data']['DURATION'] = iconv('UTF-8', 'ASCII//TRANSLIT', $DB_CONN->real_escape_string($obj['data']['DURATION']));
}

if (array_key_exists('CHILDCARE_LINK', $obj['data'])) {
	$obj['data']['CHILDCARE_LINK'] = iconv('UTF-8', 'ASCII//TRANSLIT', $DB_CONN->real_escape_string($obj['data']['CHILDCARE_LINK']));
}

if (array_key_exists('GROUP_LINK', $obj['data'])) {
	$obj['data']['GROUP_LINK'] = iconv('UTF-8', 'ASCII//TRANSLIT', $DB_CONN->real_escape_string($obj['data']['GROUP_LINK']));
}

if (array_key_exists('IDEAL_SIZE', $obj['data'])) {
	$obj['data']['IDEAL_SIZE'] = iconv('UTF-8', 'ASCII//TRANSLIT', $DB_CONN->real_escape_string($obj['data']['IDEAL_SIZE']));
}

if (array_key_exists('MEET_TIME_START', $obj['data'])) {
	$obj['data']['MEET_TIME_START'] = iconv('UTF-8', 'ASCII//TRANSLIT', $DB_CONN->real_escape_string($obj['data']['MEET_TIME_START']));
}
...
if($table == "INCIDENT") {
	...
	mysqli_query($DB_CONN, $insert) or die('{"records": [{"error": "' . mysqli_error($DB_CONN) . '"}]}');
...
if ($_SESSION["access"] == "granted") {
	if (!$newfile) {
		...
		$result = query_with_checks($DB_CONN, $query);
	}
	...
	if ($exists_in_db) {
		//Run the UPDATE
		query_with_checks($DB_CONN, $update);
		echo '{"records": [{"updated": 1, "inserted": 0}]}';
	}

	else {
		//Run the INSERT
		query_with_checks($DB_CONN, $insert);
...
function query_with_checks($DB_CONN, $command) {
	$result = mysqli_query($DB_CONN, $command);
	if (!$result) {
		error_log(mysqli_error($DB_CONN));
		die('{"records": [{"error": "' . mysqli_error($DB_CONN) . '"}]}');
	}
